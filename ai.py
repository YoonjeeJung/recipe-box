...
응답 형식:
{{
  "title": "간결한 한국어 제목 (30자 이내) — 원문이 외국어여도 한국어로 번역",
  "summary": "콘텐츠 소개 한두 문장 — 한국어 원문은 그대로 발췌, 외국어 원문은 한국어로 번역",
...
- title·summary·ingredients·steps는 모두 한국어로. 원문이 외국어면 한국어로
  번역하되 음식명 같은 고유명사는 병기 가능 (예: "토마토 칠리 콜드 누들").
